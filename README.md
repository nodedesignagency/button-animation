...
| Hover / focus | Button lifts with a springy overshoot, the grounding shadow grows, fires and glow intensify, sheen sweeps the face, all embers release |
...
- Font: [Open Runde](https://github.com/lauridskern/open-runde) by Laurids Kern, a rounded variant of Inter, SIL Open Font License 1.1. Subset to ASCII and embedded as base64 woff2.
